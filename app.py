...
if __name__ == "__main__":
    ...
    threading.Thread(target=iniciar_listener,          args=(VENDEDOR_MAP,), daemon=True).start()
    threading.Thread(target=iniciar_scheduler_diario,  args=(VENDEDOR_MAP,), daemon=True).start()
